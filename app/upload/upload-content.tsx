...
// 전부 채우면 거래처 8곳 · 거래 98건 · 열두 달이 나온다.
//
//   거래명세서 4개   72건  미래모터스·대성테크·한울전자·동방정공 각 18
//   입금내역         22건  위 4곳 각 4 + 새봄테크 3 + 한울부품 3
//   세금계산서 PDF    3건  ㈜한국테크놀로(지)
//   기업내부거래 PDF   1건  한빛금속
//
// 화면 안내 문구도 이 숫자를 적는다. **추출 결과가 달라지면 아래 문구를 같이
// 고쳐야 한다.** 세 번 어긋났다. 샘플 파일이 바뀌었을 때("6곳·6개월·21건" ←
// 실측 5곳·12개월·73건), 입금내역을 읽도록 고쳤을 때(73건 → 95건), 세금계산서
// 품목을 읽도록 고쳤을 때(95건 → 98건). 매번 추출을 고치고 문구를 잊었다.
// 안내와 실제가 다르면 값이 틀린 것보다 나쁘다 — 화면이 하는 말을 못 믿게 된다.
    ...
    >
      ...
      <div className="mb-4 flex flex-wrap items-center gap-2 rounded-lg border border-zinc-200 bg-white px-4 py-3.5">
        ...
        <span className="text-[13px] text-zinc-500">
          문서가 없어도 괜찮습니다. 샘플로 거래처 8곳·12개월치 거래 98건을
          실제로 분석해 볼 수 있습니다.
        </span>
      </div>
