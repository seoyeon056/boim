...
// 네 칸을 다 채우면 거래처 5곳 · 거래 73건 · 열두 달이 나온다.
//
// 화면 안내 문구도 이 숫자를 적는다. 샘플 파일을 바꿀 때 아래 문구를 같이
// 고치지 않으면, 안내와 실제 결과가 어긋난 채로 나간다(실제로 그랬다 —
// "거래처 6곳·6개월·21건"으로 적혀 있었는데 실측은 5곳·12개월·73건이었다).
    ...
    >
      ...
      <div className="mb-4 flex flex-wrap items-center gap-2 rounded-lg border border-zinc-200 bg-white px-4 py-3.5">
        ...
        <span className="text-[13px] text-zinc-500">
          문서가 없어도 괜찮습니다. 샘플로 거래처 5곳·12개월치 거래 73건을
          실제로 분석해 볼 수 있습니다.
        </span>
      </div>
