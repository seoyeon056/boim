  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <span className="group relative flex items-center">
        ...
        <span className="pointer-events-none absolute right-0 top-full z-20 mt-1.5 w-72 rounded-md bg-zinc-900 px-3.5 py-3 text-[11px] leading-5 text-white opacity-0 transition-opacity group-focus-within:opacity-100 group-hover:opacity-100">
