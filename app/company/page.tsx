              ...
              {isSelected && isDiagnosing && (
                <div className="mt-3">
                  {/*
                    ...
                    9~30초가 걸린다.
                    문구 간격을 늘려 두고, 기다린 초를 함께 보여 준다. 숫자가
                    움직이는 것 자체가 멈추지 않았다는 신호다.

                    이 구간에는 화면 가운데에 띄운다. 다음 화면으로 넘어가는
                    중이라 기다리는 것 말고 할 수 있는 일이 없고, 카드가 작아
                    지나치면 멈춘 것으로 오해하기 쉽다.

                    어느 축이 느린지는 그때그때 다르다(실측: 특허 조회가 같은
                    요청에 0.6초~20초로 흔들렸다). 확인하지 않은 것을 지목하지
                    않도록 특정 기관을 적지 않는다.
                  */}
                  <LoadingSteps
                    ...
                    stepMs={3500}
                    slowAfterMs={12000}
                    slowNote="공개 데이터 응답이 늦어지고 있습니다. 기다리는 중이며, 받는 대로 결과 화면으로 넘어갑니다."
                    showElapsed
                    overlay
                  />
                </div>
